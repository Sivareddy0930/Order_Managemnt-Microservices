...
public class InventoryController {
    ...
    public ResponseEntity<InventoryDto> getInventory(@PathVariable("id") Long inventoryId){
        InventoryDto inventoryDto = inventoryService.getByInventoryId(inventoryId);
